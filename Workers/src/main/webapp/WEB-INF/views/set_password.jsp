        ...
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >
                    <div class="panel-heading">
                        ...
                        <div class="panel-title">Ustaw nowe hasło</div>
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                       ...
                       <!--  <form id="loginform" class="form-horizontal" role="form"> -->
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                      ...
                                      <input id="password" type="password" class="form-control" name="user" value="" placeholder="hasło"> 
                                                                      
                                    </div>
                                
                            <div style="margin-bottom: 25px" class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                         <input id="login-password" type="password" class="form-control" name="password" placeholder="powtórz hasło">
